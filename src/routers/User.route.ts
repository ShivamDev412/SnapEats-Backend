...
routes.post(ENDPOINTS.SEND_EMAIL_OTP, AuthMiddleware, userController.sendEmailOTP);
routes.post(ENDPOINTS.VERIFY_EMAIL_OTP, AuthMiddleware, userController.verifyEmailOTP);
routes.post(ENDPOINTS.RESEND_EMAIL_OTP, AuthMiddleware, userController.resendEmailOTP);
