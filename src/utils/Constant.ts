...
export const MESSAGES = {
  ...
  STRIPE_ACCOUNT_CAPABILITIES_NOT_MET:
    "Store's Stripe account does not have the necessary capabilities",
  STRIPE_ACCOUNT_NOT_FOUND: "Stripe account not found",
  ACCOUNT_CREATION_FAILED: "Account creation failed",
  CANCELLED_ORDER_SUBJECT: "Cancelled Order",
  NO_DEFAULT_ADDRESS: "No default address found",
};
export const VALIDATION_MESSAGES = {
  ...
  CURRENT_AND_NEW_PASSWORDS_CANNOT_MATCH:
